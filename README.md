...
- [AI Security Suite](https://rapidapi.com/cybersavvyai/api/ai-security-suite) - Real-time prompt injection detection, PII scanning, and AI safety filtering for LLM applications. Detects 15+ attack patterns with a free tier of 500 scans/month. Also available as a [GitHub Action](https://github.com/southerncardinalllc-ctrl/ai-security-scanner).
